...
def im_gray(x):
	x = cv2.imread("C:/Users/ibhar/OneDrive/Pictures/smallgray.png",0)
...
im_gray = cv2.imread("C:/Users/ibhar/OneDrive/Pictures/smallgray.png",1)
print im_gray

#creating images out of numpy arrays
print cv2.imwrite("newsmallgray.png",im_gray)
